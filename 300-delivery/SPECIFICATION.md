---
Document ID: FOLDER-300-DELIVERY
Title: 300-delivery Folder Specification
Version: 0.1.0
Status: Draft
Owner: Delivery Lead
Approver: Tony
...
Purpose: Defines allowed use and audit rules for `300-delivery/`.
...
Contains self-contained workspaces for approved roadmap items moving through delivery.
