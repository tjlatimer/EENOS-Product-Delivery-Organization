---
Document ID: FOLDER-999-ARCHIVE
Title: 999-archive Folder Specification
Version: 0.1.0
Status: Draft
...
Purpose: Defines allowed use and audit rules for `999-archive/`.
...
Contains retired or superseded artifacts retained for historical traceability.
