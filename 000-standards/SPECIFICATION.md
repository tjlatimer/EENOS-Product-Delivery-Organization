---
Document ID: FOLDER-000-STANDARDS
Title: 000-standards Folder Specification
Version: 0.1.0
Status: Draft
...
Purpose: Defines allowed use and audit rules for `000-standards/`.
...
Defines shared terminology, naming, metadata, templates, and document standards.
