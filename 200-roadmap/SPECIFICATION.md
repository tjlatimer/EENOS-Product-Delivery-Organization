---
Document ID: FOLDER-200-ROADMAP
Title: 200-roadmap Folder Specification
Version: 0.1.0
Status: Draft
...
Purpose: Defines allowed use and audit rules for `200-roadmap/`.
...
Contains the current roadmap, backlog, milestones, releases, and completed roadmap records.
